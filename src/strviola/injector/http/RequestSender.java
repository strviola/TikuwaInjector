...
public class RequestSender {
	...
	public static String sendLogin(String token) {
		return senderBase(Method.post, "/auth/login/", new String[] { "token",
				token });
	}

	public static String sendLogin(String name, String psw) {
		return senderBase(Method.post, "/auth/info/", new String[] { "gmail",
				name }, new String[] { "password", psw });
	}

	public static String sendTikuwa(String id, String num) {
		return senderBase(Method.post, "/tikuwa/update/", new String[] { "tid",
				id }, new String[] { "hasnum", num });
	}
